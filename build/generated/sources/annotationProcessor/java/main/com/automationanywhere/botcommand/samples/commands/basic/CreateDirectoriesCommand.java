...
public final class CreateDirectoriesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(CreateDirectoriesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    CreateDirectories command = new CreateDirectories();
    ...
    try {
      command.action((String)convertedParameters.get("address"));Optional<Value> result = Optional.empty();
