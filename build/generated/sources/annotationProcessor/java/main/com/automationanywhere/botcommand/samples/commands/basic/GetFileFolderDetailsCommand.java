...
public final class GetFileFolderDetailsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetFileFolderDetailsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetFileFolderDetails command = new GetFileFolderDetails();
